...
public class MyAlgoBackTest extends AbstractAlgoBackTest {
        ...
        protected UnsafeBuffer createRapidlyFallingMarketScenario() {
                ...
                encoder.bidBookCount(2)
                                ...
                                .next().price(89L).size(150L);

                encoder.askBookCount(2)
                                .next().price(85L).size(300L)
                                .next().price(84L).size(250L);
        ...
        protected UnsafeBuffer createHighLiquidityMarketScenario() {
                ...
                encoder.bidBookCount(10)
                                ...
                                .next().price(99L).size(900L)
                                .next().price(98L).size(800L)
                                .next().price(97L).size(700L)
                                .next().price(96L).size(600L)
